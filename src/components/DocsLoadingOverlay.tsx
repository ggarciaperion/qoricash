/**
 * DocsLoadingOverlay — misma animación que LoginLoadingScreen
 * adaptada para el flujo de envío de documentos.
 * Ícono de documento flotante + textos de verificación.
 */
...
export const DocsLoadingOverlay: React.FC<Props> = ({ visible, onComplete }) => {
  ...
  const docIconFade  = useRef(new Animated.Value(0)).current;
  ...
  const resetAll = () => {
    ...
    logoScale.setValue(0.86); docIconFade.setValue(0);
  ...
  useEffect(() => {
    ...
    addTimer(() => {
      ...
      Animated.parallel([
        ...
        Animated.sequence([
          Animated.delay(180),
          Animated.timing(docIconFade, { toValue:1, duration:340, useNativeDriver:true }),
        ]),
        Animated.sequence([
          Animated.delay(230),
    ...
    >
      ...
      <Animated.View style={{ opacity:cardFade, transform:[{scale:cardScale},{translateY:cardY}], width:'100%', alignItems:'center' }}>
        ...
        <Animated.View style={{
          ...
          <Animated.View style={[st.docBadge, { opacity: docIconFade }]}>
            <Ionicons name="document-text-outline" size={15} color={DARK} />
            <Text style={st.docBadgeText}>Verificación de identidad</Text>
          </Animated.View>
        </Animated.View>
        ...
        <View style={st.spinWrap}>
          ...
          <Animated.View style={[st.checkWrap, { opacity:checkFade, transform:[{scale:checkScale}] }]}>
            ...
            {/* Mini documento badge sobre el círculo */}
            <View style={st.docCheckBadge}>
        ...
        <View style={st.textBlock}>
          ...
          <Animated.View style={[StyleSheet.absoluteFill, {
            ...
            <Text style={st.title}>Enviando <Text style={st.accent}>documentos</Text></Text>
          ...
          <Animated.View style={[StyleSheet.absoluteFill, {
            ...
            <Text style={st.title}>¡Documentos <Text style={st.accent}>enviados!</Text></Text>
            <Text style={st.sub}>Tu identidad será verificada pronto</Text>
          </Animated.View>
        </View>
