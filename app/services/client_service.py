    ...
    def create_client(current_user, data, files=None):
        ...
        try:
            ...
            try:
                ...
                # NOTA: La contraseña temporal se generará y enviará SOLO cuando la cuenta sea ACTIVADA
                # No se envía email al crear el cliente para evitar duplicidad de correos
                logger.info(f'Cliente {client.id} creado exitosamente. Contraseña se generará al activar cuenta.')
