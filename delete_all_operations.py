...
try:
    with engine.connect() as conn:
        ...
        # Confirmación
        print(f"\n⚠️  ADVERTENCIA: Se eliminarán TODAS las {total} operaciones")
        print("⚠️  Esto incluye EXP-1134 y cualquier otra operación")
        ...
        print("\n🗑️  Eliminando todas las operaciones...")
        ...
        if remaining == 0:
            ...
            print(f"\n⚠️  Advertencia: Aún quedan {remaining} operaciones")
